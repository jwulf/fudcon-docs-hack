...
public class TopicHome extends VersionedEntityHome<Topic> 
{
	...
	private void setMessages()
	{
		...
		this.setUpdatedMessage(createValueExpression("Your changes were saved, and will be visible when the book rebuilds."));
	}
	...
	public void pushToZanataConfirm() {
		...
		topics.add(new Pair<Integer, Integer>(this.getInstance().getTopicId(), this.getInstance().getLatestRevision().intValue()));
		this.getInstance().createTranslatedTopic();
