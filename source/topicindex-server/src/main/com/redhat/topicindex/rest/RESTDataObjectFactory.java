...
abstract class RESTDataObjectFactory<T extends BaseRESTEntityV1<T>, U>
{
	...
	{
		return this.createRESTEntityFromDBEntity(entity, baseUrl, dataType, expand, false);
	}
	 ...
	 * @return A new REST entity populated with the values in a database entity
	 */
	T createRESTEntityFromDBEntity(final U entity, final String baseUrl, final String dataType, final String expand, final boolean isRevision) throws InvalidParameterException
	{
		if (expand != null && !expand.isEmpty())
		{
			try
			{
				...
				return this.createRESTEntityFromDBEntity(entity, baseUrl, dataType, expandDataTrunk, isRevision);
			}
		...
		return this.createRESTEntityFromDBEntity(entity, baseUrl, dataType, new ExpandDataTrunk(), isRevision);
	}
	 ...
	 * @return A new REST entity populated with the values in a database entity
	 */
	T createRESTEntityFromDBPK(final Object primaryKey, final String baseUrl, final String dataType, final String expand, final boolean isRevision) throws InvalidParameterException
	{
		...
		try
		{
			...
			return createRESTEntityFromDBEntity(entity, baseUrl, dataType, expand, isRevision);
		}
		catch (final Exception ex)
		{
	 ...
	 * @return A new REST entity populated with the values in a database entity
	 */
	T createRESTEntityFromDBEntity(final U entity, final String baseUrl, final String dataType, final ExpandDataTrunk expand, final boolean isRevision) throws InvalidParameterException
	{
		return createRESTEntityFromDBEntity(entity, baseUrl, dataType, expand, isRevision, true);
	}
