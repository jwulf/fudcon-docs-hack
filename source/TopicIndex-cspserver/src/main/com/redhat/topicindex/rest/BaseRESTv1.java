...
public class BaseRESTv1
{
	...
	public static final String SNAPSHOTREVISIONS_EXPANSION_NAME = "snapshotrevisions";
	public static final String SNAPSHOTTOPICS_EXPANSION_NAME = "snapshottopics";
	public static final String SNAPSHOTTRANSLATEDDATAENTITIES_EXPANSION_NAME = "snapshottranslateddataentities";
	public static final String SNAPSHOTTRANSLATEDSTRINGS_EXPANSION_NAME = "snapshottranslatedstrings";
	public static final String WORKINGSNAPSHOTTRANSLATEDDATAENTITIES_EXPANSION_NAME = "workingsnapshottranslateddataentities";
	public static final String WORKINGSNAPSHOTTRANSLATEDSTRINGS_EXPANSION_NAME = "workingsnapshottranslatedstrings";
	public static final String SNAPSHOTS_EXPANSION_NAME = "snapshotsstrings";
	...
	public static final String SNAPSHOTTOPIC_URL_NAME = "snapshottopic";
	public static final String SNAPSHOTREVISION_URL_NAME = "snapshotrevision";
	public static final String SNAPSHOTTRANSLATEDDATA_URL_NAME = "snapshottranslateddata";
	public static final String SNAPSHOTTRANSLATEDSTRING_URL_NAME = "snapshottranslatedstring";
	...
	public static final String WORKINGSNAPSHOTTRANSLATEDDATA_URL_NAME = "workingsnapshottranslateddata";
	public static final String WORKINGSNAPSHOTTRANSLATEDSTRING_URL_NAME = "workingsnapshottranslatedstring";
	...
	public static final String SNAPSHOT_URL_NAME = "snapshot";
	...
	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> getJSONEntitiesUpdatedSince(final Class<U> type, final String idProperty, final RESTDataObjectFactory<T, U> dataObjectFactory, final String expandName, final String expand, final Date date)
	{
		return getEntitiesUpdatedSince(type, idProperty, dataObjectFactory, expandName, expand, JSON_URL, date);
	}

	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> getEntitiesUpdatedSince(final Class<U> type, final String idProperty, final RESTDataObjectFactory<T, U> dataObjectFactory, final String expandName, final String expand, final String dataType, final Date date)
	{
	...
	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> createEntities(final Class<U> type, final BaseRestCollectionV1<T> entities, final RESTDataObjectFactory<T, U> factory, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
		return createOrUdpateEntities(type, factory, entities, DatabaseOperation.CREATE, expandName, dataType, expand, baseUrl);
	}

	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> updateEntities(final Class<U> type, final BaseRestCollectionV1<T> entities, final RESTDataObjectFactory<T, U> factory, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
	 ...
	 */
	private <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> createOrUdpateEntities(final Class<U> type, final RESTDataObjectFactory<T, U> factory, final BaseRestCollectionV1<T> entities, final DatabaseOperation operation, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
	...
	protected <T extends BaseRESTEntityV1<T>, U> T getJSONResource(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final Object id, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResource(type, dataObjectFactory, id, expand, JSON_URL);
	}

	protected <T extends BaseRESTEntityV1<T>, U> T getXMLResource(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final Object id, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResource(type, dataObjectFactory, id, expand, XML_URL);
	}

	private <T extends BaseRESTEntityV1<T>, U> T getResource(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final Object id, final String expand, final String dataType) throws InvalidParameterException, InternalProcessingException
	{
		...
		try
		{
			...
			final T restRepresentation = dataObjectFactory.createRESTEntityFromDBEntity(entity, this.getBaseUrl(), dataType, expand);
	...
	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> getXMLResources(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final String expandName, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResources(type, dataObjectFactory, expandName, expand, XML_URL);
	}

	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> getJSONResources(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final String expandName, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResources(type, dataObjectFactory, expandName, expand, JSON_URL);
	}

	protected <T extends BaseRESTEntityV1<T>, U extends AuditedEntity> BaseRestCollectionV1<T> getResources(final Class<U> type, final RESTDataObjectFactory<T, U> dataObjectFactory, final String expandName, final String expand, final String dataType) throws InvalidParameterException, InternalProcessingException
	{
		assert type != null : "The type parameter can not be null";
		assert dataObjectFactory != null : "The dataObjectFactory parameter can not be null";
	...
	protected BaseRestCollectionV1<TopicV1> getJSONTopicsFromQuery(final MultivaluedMap<String, String> queryParams, final TopicV1Factory dataObjectFactory, final String expandName, final String expand) throws InternalProcessingException
	{
		return getTopicsFromQuery(queryParams, dataObjectFactory, expandName, expand, JSON_URL);
	}

	protected BaseRestCollectionV1<TopicV1> getTopicsFromQuery(final MultivaluedMap<String, String> queryParams, final TopicV1Factory dataObjectFactory, final String expandName, final String expand, final String dataType) throws InternalProcessingException
	{
		assert dataObjectFactory != null : "The dataObjectFactory parameter can not be null";
		...
		try
		{
			...
			final BaseRestCollectionV1<TopicV1> retValue = new RESTDataObjectCollectionFactory<TopicV1, Topic>().create(dataObjectFactory, result, expandName, dataType, expandDataTrunk, getBaseUrl());
