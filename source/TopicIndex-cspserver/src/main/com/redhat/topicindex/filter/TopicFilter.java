...
public class TopicFilter
{
	...
	private Integer snapshotRevisionId;
	...
	public String getFieldValue(final String fieldName)
	{
		if (fieldName.equals(Constants.TOPIC_IDS_FILTER_VAR))
			...
			return this.snapshotRevisionId == null ? null : snapshotRevisionId.toString();
		else if (fieldName.equals(Constants.SNAPSHOT_ID))
			return this.snapshotId == null ? null : snapshotId.toString();
	...
	public void setFieldValue(final String fieldName, final String fieldValue)
	{
		...
		else if (fieldName.equals(Constants.SNAPSHOT_REVISION_ID))
		{
			try
			{
				this.setSnapshotRevisionId(fieldValue == null ? null : Integer.parseInt(fieldValue));
			}
			catch (final Exception ex)
			{
				// could not parse integer, so silently fail
				SkynetExceptionUtilities.handleException(ex, true, "Probably a malformed URL query parameter for the 'Snapshot Revision ID' field");
			}
		}
		else if (fieldName.equals(Constants.SNAPSHOT_ID))
		{
			try
			{
				this.setSnapshotId(fieldValue == null ? null : Integer.parseInt(fieldValue));
			}
			catch (final Exception ex)
			{
				// could not parse integer, so silently fail
				SkynetExceptionUtilities.handleException(ex, true, "Probably a malformed URL query parameter for the 'Snapshot ID' field");
			}
		}
		else if (fieldName.equals(Constants.TOPIC_HAS_OPEN_BUGZILLA_BUGS))
		{
	...
	public Map<String, String> getFilterValues()
	{
		...
		retValue.put(Constants.SNAPSHOT_REVISION_ID, this.getSnapshotRevisionId() == null ? "" : this.getSnapshotRevisionId().toString());
		retValue.put(Constants.SNAPSHOT_ID, this.getSnapshotId() == null ? "" : this.getSnapshotId().toString());
		retValue.put(Constants.TOPIC_HAS_OPEN_BUGZILLA_BUGS, this.getHasOpenBugzillaBugs() == null ? "" : this.getHasOpenBugzillaBugs().toString());
		retValue.put(Constants.TOPIC_HAS_BUGZILLA_BUGS, this.getHasBugzillaBugs() == null ? "" : this.getHasBugzillaBugs().toString());
	...
	private static Map<String, String> getSingleFilterNames()
	{
		...
		retValue.put(Constants.SNAPSHOT_REVISION_ID, Constants.SNAPSHOT_REVISION_ID_DESC);
		retValue.put(Constants.SNAPSHOT_ID, Constants.SNAPSHOT_ID_DESC);
	...
	public Integer getSnapshotRevisionId()
	{
		return snapshotRevisionId;
	}

	public void setSnapshotRevisionId(final Integer snapshotRevisionId)
	{
